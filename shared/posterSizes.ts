export type PosterSizeId =
  | "5x7" | "6x6" | "8x8" | "8x10" | "9x12"
  | "10x10" | "10x20" | "11x14" | "12x12" | "12x16" | "12x18" | "12x24" | "12x36"
  | "14x14" | "16x16" | "16x20" | "16x32" | "16x48"
...
export const POSTER_SIZES: PosterSize[] = [
  ...
  // 2:3
  s("12x18", 12, 18, 1139, 3876), s("20x30", 20, 30, 1289, 16365), s("24x36", 24, 36, 1789, 2), s("40x60", 40, 60),
